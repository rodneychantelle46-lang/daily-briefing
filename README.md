...
### 午报（每日 12:00）
- **计网 × AI 知识学习** — 面向文科生的计算机网络与 AI 基础学习卡片，每天 2 个短知识点：1 个计网 + 1 个 AI 基础
...
午报保留三张知识卡片 + GitHub 热门项目结构。第一栏已从 AI 技巧改为“计网 × AI 知识学习”：按网络基础、Web/API、数据与系统、AI 基础、AI 工程五块知识地图推进；这个栏目每天固定 2 个短知识点，1 个计网/互联网原理 + 1 个 AI 基础/AI 工程，面向文科生深入浅出讲解，但控制篇幅；每个知识点强制输出标题、正文和“试一下”。GitHub 热门项目会先做候选质量排序，再生成“看点/可用”点评。
